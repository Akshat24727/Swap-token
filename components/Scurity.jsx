  ...
  return (
    <div className="scurity">
      <div className="icon-one">
        <img arc="assets/img/scurity-vector-1.png" alt=""/>   
      </div>
      <div className="icon-two">
        <img arc="assets/img/scurity-vector-2.png" alt=""/>   
      </div>

      <div className="container">
        <div className="row justify-content-center">
          <div className="col-lg-10 text-center fadeInUp"
               data-wow-duration="0.3s"
               data-wow-delay="0.3s"> 
            <div className="section-head">
              <h4 className="lasthead">Secure Exchange</h4>
              <h2 className="title">Security & compliance</h2>
              <p className="text">I'm the best in the world at what I do and what I do isn't very nice.</p>
            </div>
          </div>
        </div>
        ...
        <div className="box">
          <div className="row justify-content-center">
            ...
            <div className="col-xl-4 col-lg-6 wow fadeInUp"
                 ...
                 data-wow-delay="0.5s">
              <div className="scurity-box three">
                <div className="icon">
                  <img src="assets/img/scurity-icon-3.png" alt=""/>
                </div>
                <div className="content">
                  <h5 className="cont-head">2FA</h5>
                  <p className="text">2 Steps Verification</p>
                </div>
              </div>
            </div>
          </div>
