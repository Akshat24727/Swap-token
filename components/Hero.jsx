  ...
  return (
    ...
    id="home" style={{
      ...
      <div className="hero-area">
          ...
          <h1 className="head">Crypto Currency Exchange</h1>
          <p className="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
        
      </div>
      </div>
      <div className="col-xl-4 col-lg-6 wow fadeInRightBig" data-wow-delay="0.3s"
      data-wow-duration="0.5s">
          ...
          <a className="rotate">
              ...
              onClick={()=> reset(token_1,token_2, inputAmount)}/>
          </a>
          <div className="exchange-box">
              <div className="selector">
